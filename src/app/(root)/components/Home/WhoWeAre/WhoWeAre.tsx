...
const WhoWeAre = () => {
    ...
    const features = [
        {
            icon: <FaUsersGear className='text-7xl p-4  bg-primaryCol rounded-full' />,
        ...
        {
            icon: <RiSecurePaymentFill className='text-7xl p-4  bg-primaryCol rounded-full' />,
        ...
        {
            icon: <BiSupport className='text-7xl p-4  bg-primaryCol rounded-full' />,
            name: "24/7 Support",
    ...
    return (
        <div className='wrapper flex justify-center gap-10 my-20'>
            ...
            <div className='flex-1'>
                ...
                <div className='flex flex-col justify-center items-start gap-3 my-6'>
                    {
                        features.map((feature, indx) => <div key={indx} className="flex duration-300 flex-1 w-full rounded-md items-center justify-start gap-4 py-4 hover:drop-shadow-2xl select-none group">
                            ...
                            <div>
                                <h3 className='text-2xl uppercase font-bold'>{feature.name}</h3>

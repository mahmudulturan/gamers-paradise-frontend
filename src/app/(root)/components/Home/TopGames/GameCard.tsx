...
const GameCard = ({ game }: { game: IGame }) => {
    return (
        <Link href={`/top-up${game.route}`} className='rounded bg-seconderyCol hover:bg-primaryCol duration-300 flex items-center justify-center flex-col gap-2 pt-5 pb-4 group'>

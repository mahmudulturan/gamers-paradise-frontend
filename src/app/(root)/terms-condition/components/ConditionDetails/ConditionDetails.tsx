        ...
        <div className='space-y-8'>
            ...
            <div className='text-center'>
                ...
                <div className='text-white/75  my-3 space-y-2 font-medium mx-auto text-left'>
                    <span className='block'>
                        We offer a 14-day money-back guarantee on all purchases. If you got any wrong product from our side, you can request a refund within 14 days of the transaction date.
                    </span>
                    <span className='block'>
